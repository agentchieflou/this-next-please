---
name: oracle-query
description: Use for any read-only SQL against Oracle. Use when the task needs counts, rows, history, or validation from this source. Never call the database directly; use ad-ora.
---
...
2. Run `ad-ora --env <env from AGENTS.md> --sql-file <that file> --name <purpose>`.
