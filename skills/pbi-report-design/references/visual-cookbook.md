...
- **Variance at the bar end** (e.g. Recent vs Average): a native data label on the one series, never a reason for a
  custom visual. Recipe: skill `pbi-custom-visual`, `references/delivery-routes.md` §Bar-end variance labels.
