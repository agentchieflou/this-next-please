...
In `marks`, above `{ selector: ".tile.ink-example .head", tool: variant === "red" ? "red" : "pen", shape: " …`:
...
Above `export const sampleGround = false;`:
...
every cue this page played, for `inspect`
