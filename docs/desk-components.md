...
| inspector | facts, rail, spend pane, branches pane, verify; open friction and the closed *earlier friction (n)* fold, each row with *dismiss* (#499) | `drawInspector` | `#inspectordetails`, `.frictionrow.quiet`, `.friction-earlier` | — | — | `test_fleet_branches.py`, `test_fleet_board_desk.py` |
