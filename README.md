...
| `docs/desk-ink.md` | the ink layer (#248): one three.js canvas behind the desk, a lane of drawing per agent, marks derived from the page's own classes and drawn by pencil, pen, marker and highlighter, the gate a shell's WebGL probe sets, and the plain CSS fallback — built, and not yet used by any skin |
